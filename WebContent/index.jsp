...
<body>
    ...
    %>
    <h2 style="align:center">Message saved successfully</h2>
    <%} session.removeAttribute("msg");%>	
 --%>

	<h3 style="text-align: center; color: blue">
		<%@include file="messagebox/message.jsp"%></h3>
	<!-- ABOUT -->
	<section
			...
			<div class="row">
					...
					<div class="about-text">
						...
						<h1 class="animated animated-text">
							...
							<div class="animated-info">
								<span class="animated-item">Tejas Kadam</span> <span
									class="animated-item">Student</span> 
									<span
									class="animated-item">Full Stack Developer</span>
							</div>
						</h1>

						<br><p>Building a successful product is a challenge. I am highly
				...
				<div class="col-lg-5 col-md-12 col-12">
					<div class="about-image svg">
						<img style="height: 325px; padding-left: 200px;"    src="images/undraw/Tejas_Kadam.jpeg"
			...
			<div class="row">
				<div class="col-lg-11 text-center mx-auto col-12">
					...
					<div class="owl-carousel owl-theme">
						<% Read rr=new Read();
						ArrayList<Photo> alll=rr.Readpic();
						...
						<div class="item">
							<div class="project-info">
								<img src="images/project/<%=p3.getFilename()%>" class="img-fluid" alt="project image">
							</div>
						</div>
						<% }%>
					...
					<div class="timeline">
						<div class="timeline-wrapper">
							...
							<div class="timeline-info">
								<h3>
									<span>Intern</span><small>Best Studio</small>
								</h3>
								<p>Intern at Dataviss Analytics</p>
							</div>
						</div>
						...
						<div class="timeline-wrapper">
							...
							<div class="timeline-info">
								...
								<p>A Spring Boot enthusiats (Spring JPA,Spring Security,Spring Web.Spring Devtools).</p>
							</div>
						</div>
...
<!-- 						<div class="timeline-wrapper">
						...
						<div class="timeline-wrapper">
							...
							<div class="timeline-info">
								<h3>
									<span>AngularJS Developer<!-- <small>Crafted Co.</small> -->
								</h3>
								<p>A frontend developer with Hands-on AngularJS Framework.</p>
							</div>
						</div>
				...
				<div class="col-lg-6 col-12">
					...
					<div class="timeline">
						<%
							Read r = new Read();
							ArrayList<Student> al = r.updation();
							for (Student s1 : al) {
						%>

						<div class="timeline-wrapper">
							<div class="timeline-yr">
								<span><%=s1.getYear()%></span>
							</div>
							<div class="timeline-info">
								<h3>
									<span><%=s1.getStd()%></span><small><%=s1.getBoard()%></small>
								</h3>
								<p>
									<%=s1.getSchool()%></p>
							</div>
				...
				<div class="col-lg-5 mr-lg-5 col-12">
					...
					<div
						...
						<div class="contact-info-item">
							...
							<p class="footer-text mb-0">7875807364</p>
							<p>
								<!-- <a <!-- href="tejaskadam7107@gmail.com" --></a> -->
								<a>tejaskadam7107@gmail.com</a>
							</p>
						</div>
